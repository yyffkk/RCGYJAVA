...
/**
 * 巡检执行情况（巡检计划周期的记录）Vo list 回显
 */
public class SDSysInspectionExecuteVo {
    /**
     * 主键id
     */
    private Integer id;
    ...
    public String toString() {
        return "SDSysInspectionExecuteVo{" +
                "id=" + id +
    ...
    public SDSysInspectionExecuteVo() {
    }

    public SDSysInspectionExecuteVo(Integer id, Integer inspectionPlanId, Date beginDate, Date endDate, Date actualBeginDate, Date actualEndDate, Integer sort) {
        this.id = id;
        this.inspectionPlanId = inspectionPlanId;
        this.beginDate = beginDate;
        this.endDate = endDate;
