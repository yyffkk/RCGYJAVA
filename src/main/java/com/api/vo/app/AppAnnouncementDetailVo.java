 ...
 * app社区公告详情信息Vo 回显
 */
public class AppAnnouncementDetailVo {
    /**
     * 主键id
     */
    private Integer id;
    ...
    public String toString() {
        return "AppAnnouncementDetailVo{" +
                "id=" + id +
                ", title='" + title + '\'' +
                ", content='" + content + '\'' +
    ...
    public AppAnnouncementDetailVo() {
    }

    public AppAnnouncementDetailVo(Integer id, String title, String content, String fileDocUrl, String fileDocName, Date releaseTime, List<VoResourcesImg> imgUrls) {
        this.id = id;
        this.title = title;
        this.content = content;
        this.fileDocUrl = fileDocUrl;
