 ...
 * 考勤排班计划例外情况Vo集合
 */
public class SysAttendanceSchedulingPlanExceptionVo {
    /**
     * 主键id
     */
    private Integer id;
    ...
    public String toString() {
        return "SysAttendanceSchedulingPlanExceptionVo{" +
                "id=" + id +
    ...
    public SysAttendanceSchedulingPlanExceptionVo() {
    }

    public SysAttendanceSchedulingPlanExceptionVo(Integer id, Integer attendanceSchedulingPlanId, Date dateRange, Time firstTimeStart, Time firstTimeEnd, Time secondTimeStart, Time secondTimeEnd, Integer type, String remakes) {
        this.id = id;
        this.attendanceSchedulingPlanId = attendanceSchedulingPlanId;
        this.dateRange = dateRange;
        this.firstTimeStart = firstTimeStart;
