 ...
 * 排班计划详情Vo集合
 */
public class SysAttendanceSchedulingPlanDetailVo {
    /**
     * 主键id
     */
    private Integer id;
    ...
    public String toString() {
        return "SysAttendanceSchedulingPlanDetailVo{" +
                "id=" + id +
    ...
    public SysAttendanceSchedulingPlanDetailVo() {
    }

    public SysAttendanceSchedulingPlanDetailVo(Integer id, Integer attendanceSchedulingPlanId, Integer workingDays, Time firstTimeStart, Time firstTimeEnd, Time secondTimeStart, Time secondTimeEnd) {
        this.id = id;
        this.attendanceSchedulingPlanId = attendanceSchedulingPlanId;
        this.workingDays = workingDays;
        this.firstTimeStart = firstTimeStart;
