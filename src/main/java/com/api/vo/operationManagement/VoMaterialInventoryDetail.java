...
public class VoMaterialInventoryDetail {
    ...
    public VoMaterialInventoryDetail(Integer id, Integer materialInventoryId, String name, Integer shouldInventory, Integer actualInventory, Integer inventorySurplusLosses) {
        this.id = id;
        this.materialInventoryId = materialInventoryId;
        this.name = name;
        this.shouldInventory = shouldInventory;
