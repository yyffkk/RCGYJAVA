...
/**
 * app 家政服务-服务费用支付订单model
 */
public class SysHousekeepingServiceOrder {
    /**
     * 主键id
     */
    private Integer id;
    ...
    public String toString() {
        return "SysHousekeepingServiceOrder{" +
                "id=" + id +
    ...
    public SysHousekeepingServiceOrder() {
    }

    public SysHousekeepingServiceOrder(Integer id, Integer housekeepingServiceId, String code, String name, String tel, Integer payType, BigDecimal payPrice, Integer createId, Date createDate, String remake, Integer status) {
        this.id = id;
        this.housekeepingServiceId = housekeepingServiceId;
        this.code = code;
        this.name = name;
