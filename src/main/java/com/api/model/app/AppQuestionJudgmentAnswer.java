 ...
 * 判断题答案
 */
public class AppQuestionJudgmentAnswer {
    /**
     * 问卷id
     */
    ...
    public String toString() {
        return "AppQuestionJudgmentAnswer{" +
    ...
    public AppQuestionJudgmentAnswer() {
    }

    public AppQuestionJudgmentAnswer(Integer questionnaireId, Integer questionnaireTopicId, Integer answer, Integer createId, Date createDate) {
        this.questionnaireId = questionnaireId;
        this.questionnaireTopicId = questionnaireTopicId;
        this.answer = answer;
        this.createId = createId;
