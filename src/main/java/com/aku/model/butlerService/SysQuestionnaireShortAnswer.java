 ...
 * 开放题答案
 */
public class SysQuestionnaireShortAnswer {
    /**
     * 问卷id
     */
    ...
    public String toString() {
        return "SysQuestionnaireShortAnswer{" +
    ...
    public SysQuestionnaireShortAnswer() {
    }

    public SysQuestionnaireShortAnswer(Integer questionnaireId, Integer questionnaireTopicId, String answer, Integer createId, Date createDate) {
        this.questionnaireId = questionnaireId;
        this.questionnaireTopicId = questionnaireTopicId;
        this.answer = answer;
        this.createId = createId;
